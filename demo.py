...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3,out_channels=6,kernel_size=5,stride=1,padding=0) # input:32*32*3 output:28*28*6
        self.conv2 = nn.Conv2d(in_channels=6,out_channels=16,kernel_size=5,stride=1,padding=0) # input:14*14*6 output:10*10*16
